...
export default class SolarSystemScene extends Scene {
    ...
    private drawSystem(parent: mat4, system: SolarSystemDescription){
        ...
        //Rotate around a system
        mat4.rotateY(matPlanet,matPlanet,this.time * system.rotationSpeedAroundParent);
        mat4.translate(matPlanet,matPlanet,[system.distanceFromParent,0,0]);
        mat4.rotateY(matPlanet,matPlanet,-this.time*system.rotationSpeedAroundParent)
        //Save this matrix for next child if exist
        let matChild = mat4.clone(matPlanet);
